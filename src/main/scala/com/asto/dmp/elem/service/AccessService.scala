...
import com.asto.dmp.elem.base.Main._
  ...
  def run(): Unit = {
    try {
      ...
      fakedRate.leftOuterJoin(shopDuration)
        ...
        .map(t => (t._1, t._2._1._1._1._1._1, t._2._1._1._1._2.get, t._2._1._1._2.get, t._2._2.get, t._2._1._2.get, t._2._1._1._1._1._2))
        .map(t => (t._1, t._2, t._3, t._4, t._5, t._6, t._7, t._3 >= 6 && t._4 >= 1000 && t._5 >= 1 && t._6 >= 1 && t._7 <= 0.2))//(餐厅ID:17644,餐厅名称:美食美客,平台连续经营时间:14,日均净营业额:1372.866858678956,基于3个月的营业额增长率:1.2516462000131865,基于1个月的营业额增长率:1.013666223088784037,刷单率：0.0850489185650941,是否准入：true/false)
